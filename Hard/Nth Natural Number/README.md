<h2><a href="https://www.geeksforgeeks.org/problems/nth-natural-number/1?page=8&difficulty=Hard&sortBy=difficulty">Nth Natural Number</a></h2><h3>Difficulty Level : Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a positive integer N. You have to find <strong>N<sup>th</sup></strong>&nbsp;natural number after removing all the numbers containing digit <strong>9</strong>.</span></p>
