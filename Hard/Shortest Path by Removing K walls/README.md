<h2><a href="https://www.geeksforgeeks.org/problems/shortest-path-by-removing-k-walls/1?page=3&difficulty=Hard&sortBy=difficulty">Shortest Path by Removing K walls</a></h2><h3>Difficulty Level : Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a 2-D binary <strong>matrix</strong> of size <strong>n*m</strong>, where 0 represents an empty space while 1 represents a wall you cannot walk through. You are also given an integer <strong>k</strong>.<br>
