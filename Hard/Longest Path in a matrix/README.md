<h2><a href="https://www.geeksforgeeks.org/problems/longest-path-in-a-matrix3019/1?page=2&difficulty=Hard&status=unsolved&sortBy=submissions">Longest Path in a matrix</a></h2><h3>Difficulty Level : Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a n*m&nbsp;matrix, find the maximum length path (starting from any cell) such that all cells along the path are in strictly increasing order.</span></p>
